...
def tag_with_locations(test_images, predictions, tile_size):
    ...
    for idx, img_loc_tuple in enumerate(test_images):
        ...
        ne_lat, ne_lon = pixel_to_lat_lon_web_mercator(raster_dataset, img_loc_tuple[1][0] * tile_size +
                                          tile_size, img_loc_tuple[1][1] * tile_size)
        sw_lat, sw_lon = pixel_to_lat_lon_web_mercator(raster_dataset, img_loc_tuple[1][0] * tile_size,
